...
public class JobController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, "Job Successfully Created");
    ...
    public void update() {
        persist(PersistAction.UPDATE, "Job Successfully Updated");
    }

    public void destroy() {
        persist(PersistAction.DELETE, "Job Successfully Deleted");
        if (!JsfUtil.isValidationFailed()) {
